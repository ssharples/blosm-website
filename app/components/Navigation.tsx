  ...
  return (
    <motion.nav
      ...
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
        scrolled
          ? 'bg-blosm-darker/95 backdrop-blur-lg border-b border-blosm-border-subtle shadow-lg shadow-black/10'
          : 'bg-blosm-darker/80 backdrop-blur-md border-b border-transparent'
      }`}
    >
            ...
            <AnimatePresence>
              {solutionsOpen && (
                <motion.div
                  ...
                  className="absolute top-full left-0 mt-3 w-60 bg-blosm-card border border-blosm-border rounded-xl shadow-2xl shadow-black/20 py-2 overflow-hidden"
                >
                  <Link
      ...
      <AnimatePresence>
        {mobileMenuOpen && (
          <motion.div
            ...
            className="md:hidden bg-blosm-darker border-t border-blosm-border-subtle overflow-hidden"
          >
